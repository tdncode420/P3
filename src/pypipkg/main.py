...
def initNew(args):
    ...
    pkgComplete = _pu.writeReqPkgFiles(cfg)
    if pkgComplete == False:
        return
    else:
        print('Package directory and files created successfully at ' + cfg.dir)
        print('Once finished, run command:\'p3 build\' from the directory\'s root to build the package.')
